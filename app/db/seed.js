                    ...
                    if (err) {
                        ...
                        Class.remove({}, function (err) {
                            if (err) {
                                ...
                                SwapRequest.remove({}, function (err) {
                                    if (err) {
                                        console.log("Problem removing SwapRequest: " + err)
                                    } else {
                                        ...
                                        data.swapRequests.forEach(function(swapRequest){
                                            SwapRequest.create(swapRequest, function(err, data){
                                                if (err) {
                                                    console.log("Problem adding SwapRequet: " + err)
                                                }
                                            });
                                        });
                                        console.log("SwapRequests have been added...");
                                        res.send("Done.");
                                    }
                                });
                            }
